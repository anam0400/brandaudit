<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form id="form1" method="POST" action="<?=base_url()?>admin/pengguna/addProccess">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputnama">Nama <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="inputnama" class="form-control form-control-sm" name="nama_user" required>
                    </div>
                    <div class="form-group">
                        <label for="inputusername">Username <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="inputusername" class="form-control form-control-sm" name="username" required>
                    </div>                    
                </div>
