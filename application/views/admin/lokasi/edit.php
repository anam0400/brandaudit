...
<script>
    ...
    $(document).ready(function () {
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            sendLatitude(<?=$data->data->result->latitude?>);
            sendLongitude(<?=$data->data->result->longitude?>);
...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
    <form id="form1" method="POST" action="<?=base_url()?>admin/lokasi/editProccess/<?=$id?>" enctype="multipart/form-data">
        <!-- <form id="form1" method="POST" action="<?=base_url()?>admin/lokasi/editProccess/<?=$id?>" enc> -->
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="inputNama" class="form-control form-control-sm" name="lokasi_nama"
                            required value="<?=$data->data->result->lokasi_nama?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="latitude" class="form-control form-control-sm" name="latitude" required value="<?=$data->data->result->latitude?>">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" id="longitude" class="form-control form-control-sm" name="longitude"
                            required value="<?=$data->data->result->longitude?>">
                    </div>
                    <div class="form-group">
