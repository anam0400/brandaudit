<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form id="form1" method="POST" action="<?=base_url()?>admin/relawan/addProccess">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputnama">Nama <span class="text-sm text-danger">*</span></label>
                        <input type="text" id="inputnama" class="form-control form-control-sm" name="nama_relawan" required>
                    </div>
                    <div class="form-group">
                        <label for="inputkontak">Kontak</label>
                        <input type="text" id="inputkontak" class="form-control form-control-sm" name="kontak_relawan" required>
                    </div>         
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="jenis_relawan">Jenis Relawan <span class="text-sm text-danger">*</span></label>
