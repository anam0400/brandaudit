...
<script>	
    ...
    {	
        loads();	
        $.get("<?=base_url()?>admin/pengumpulan_sampah/getData", '', function(data){	
    ...
    {	
        ...
        $.post("<?=base_url()?>admin/pengumpulan_sampah/tambahData", formData, function(data){	
            data = JSON.parse(data);	
            if (data.succ){	
                $('#totalMembers').val(1);	
                getData();	
    ...
    {	
        loads();	
        $.get("<?=base_url()?>admin/pengumpulan_sampah/updateData", '', function(data){	
            data = JSON.parse(data);	
            if (data.succ){	
                $('#formData').html(data.data);	
            }else{	
